                ...
                @else
                    ...
                    <div class="follow-button" style="width: 35%;float:right;">
                        @if(is_null($user->follow_id()))
                            <a class="btn btn-primary js-follow" data-followed-user-id="{{$user->id}}" data-follow-id="null" role="button">フォローする</a>
                        @else
                            <a class="btn btn-primary btn-reverse js-follow" data-followed-user-id="{{$user->id}}" data-follow-id="{{$user->follow_id()}}" role="button">フォロー外す</a>
                        @endif
                    </div>  
                @endif
